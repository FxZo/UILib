...
if CoreGui:FindFirstChild("Foxozo") then CoreGui:FindFirstChild("Foxozo"):Destroy() end
...
table.insert(Library.Signals, RenderStepped:Connect(function(Foxozo)
    RainbowStep = RainbowStep + Foxozo
...
function Library:CreateWindow(...)
    ...
    if typeof(Config.Size) ~= 'UDim2' then Config.Size = UDim2.fromOffset(475, 300) end
    ...
    function Library:Toggle()
        ...
        if Toggled then
            ...
            task.spawn(function()
                ...
                CursorOutline.Color = Color3.new(0, 38, 255);
